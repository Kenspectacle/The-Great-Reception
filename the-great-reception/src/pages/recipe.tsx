...
//         const cookTime = urlParams.get('cook_time');
//         const ingredients = urlParams.get('ingredients');
//         const instructions = urlParams.get('instructions');
//         const nutrition = urlParams.get('nutrition');
//         const prepTime = urlParams.get('prep_time');
//         const servings = urlParams.get('servings');
//         const tags = urlParams.get('tags');
//         const totalTime = urlParams.get('total_time');
